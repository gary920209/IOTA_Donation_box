...
const ProjectPage: React.FC = () => {
  ...
  const Donation_Address = 'tst1qqcs8n0yptzu8vhf69xaaq3uj2jzhmddpg22q5easewcm3yzlf6d5cc9zxr'
  const handleDonate = async () => {
    await sendTransaction("Cheesecake", donationAmount*1000000, Donation_Address)
  ...
  const handleCheckBalance = async () => {
    await checkBalance('project3');
    const data = await getItemByName("Project 3");
