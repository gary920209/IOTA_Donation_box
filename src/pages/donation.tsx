      ...
      <div className="mt-10 px-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col space-y-2 text-2xl font-bold text-gray-500">
            ...
            <span className="text-sm text-gray-400">Make sure to check targeted amount</span>
          </div>
          <span className="mb-5 rounded-full bg-[#74e9e3] px-3 py-1 text-sm font-bold text-white">Other</span>
        </div>
        ...
        <span className="text-xl font-bold text-gray-600">Select Payment Method</span>
        <div className="mt-5 flex justify-between">
          <div className="flex items-center justify-between space-x-3 rounded-3xl border border-green-400 py-4 px-5">
            ...
            <div className="flex flex-col text-3xl text-gray-500">
              <span>PAY1</span>
              <span className="text-sm font-normal text-gray-400">max $5000</span>
            </div>
          </div>
          <div className="flex items-center justify-between space-x-3 rounded-3xl border border-green-400 py-4 px-5">
            <div className="h-7 w-9 rounded-md bg-slate-800" />
            <div className="flex flex-col text-3xl text-gray-500">
              <span>Card</span>
              <span className="text-sm font-normal text-gray-400">credit/debit</span>
            </div>
          </div>
        </div>
