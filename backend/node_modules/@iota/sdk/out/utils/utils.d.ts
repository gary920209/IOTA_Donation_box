import { Address, HexEncodedString, Block, Ed25519Signature, TransactionEssence, MilestonePayload, MilestoneId, TransactionPayload, TransactionId, TokenSchemeType, Output, IRent, OutputId, Bech32Address, InputSigningData, INodeInfoProtocol } from '../types';
...
export declare class Utils {
     ...
     */
    static verifyTransactionSemantic(inputs: InputSigningData[], transaction: TransactionPayload, time: number): string;
    /**
     ...
     * @returns void.
     */
    static verifyTransactionSyntax(transaction: TransactionPayload, protocolParameters: INodeInfoProtocol): void;
    /**
